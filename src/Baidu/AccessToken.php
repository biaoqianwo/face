...
class AccessToken
{
     ...
     * Http Instance
     *
     * @var \Biaoqianwo\Face\Support\Http
     */
    protected $http;
     ...
     * @var string
     */
    protected $prefix = 'biaoqianwo.ocr.access_token';
    ...
    protected function getTokenFormApi()
    {
        ...
        if (empty($token[$this->tokenSucessKey])) {
            throw new RuntimeException('Request AccessToken fail. response: ' . json_encode($token,
     ...
     *
     * @param \Biaoqianwo\Face\Support\Http $http
     *
     * @return $this
     */
